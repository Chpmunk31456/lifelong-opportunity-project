...
docx_path = root / '08-human-resources-assistant/english/docx/Lifelong_Opportunity_Human_Resources_Assistant_Guide_English_v1.0.docx'
pdf_path = root / '08-human-resources-assistant/english/pdf/Lifelong_Opportunity_Human_Resources_Assistant_Guide_English_v1.0.pdf'
out = root / 'project/revision-2026/guide-08/qa/evidence'
...
pdf_text='\n'.join(pages)
(out/'guide08_legacy_docx_extract.txt').write_text(clean_lines(doc_text),encoding='utf-8')
(out/'guide08_legacy_pdf_extract.txt').write_text(clean_lines(pdf_text),encoding='utf-8')
...
report=[
'# Guide 08 — Legacy English Extraction and Reconciliation 02','',
'Date: 2026-08-08','Branch: `revision/guide-00-100-2026`','Guide: 08 — Human Resources Assistant','',
'## Gate purpose','',
...
'- DOCX Git blob SHA: `f67a535e09890ea2a837dad341f3115e5c963b53`',
'- PDF Git blob SHA: `0a46009a61de1c4cc592381c7d2c77660b6b57f7`',
...
report += ['','## Evidence files','','- `guide08_legacy_docx_extract.txt`','- `guide08_legacy_pdf_extract.txt`','','## Controlled decision','','**HOLD for substantive reconciliation.** Automated similarity does not by itself prove substantive equivalence. Review substantive sections and record the composite-source decision before drafting the revised English master.','']
(root/'project/revision-2026/guide-08/qa/GUIDE_08_LEGACY_ENGLISH_EXTRACTION_RECONCILIATION_02.md').write_text(clean_lines('\n'.join(report)),encoding='utf-8')
