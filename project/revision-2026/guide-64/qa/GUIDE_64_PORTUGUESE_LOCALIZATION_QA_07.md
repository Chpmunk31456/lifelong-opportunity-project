# Guide 64 — Portuguese Localization QA
...
Brazilian Portuguese was localized independently from the frozen English Version 2 master:
...
The Spanish edition was not used as the translation source.
...
- SENA program title and duration preserved: **Gestión comunitaria del riesgo de desastres — 1.920 horas**
...
The edition uses natural Brazilian Portuguese while preserving official occupational classifications, source names, controlled identifiers, and Colombia-specific SENA program titles where translation could change classification meaning. Numeric punctuation is localized in prose without altering underlying values.

Terminology avoids presenting a generic coordinator role as licensed social work, clinical practice, legal practice, fiduciary authority, government-benefit adjudication, grantmaking authority, or management authority unless formally assigned.
