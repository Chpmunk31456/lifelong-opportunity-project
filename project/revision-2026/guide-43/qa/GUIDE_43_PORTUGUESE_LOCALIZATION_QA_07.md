# Guide 43 — Portuguese Localization QA 07
...
- Portuguese master: `project/revision-2026/guide-43/working-masters/GUIDE_43_SOLAR_PHOTOVOLTAIC_INSTALLER_PTBR_v2.md`
...
6. **Source URLs:** The complete controlled source URL set from the frozen English master is retained unchanged in the Portuguese source section, including BLS, O*NET, OSHA, Apprenticeship.gov, Federal Student Aid, DOL/WIOA, Canada Job Bank, Red Seal, both SENA/Betowa entries, Colombia Ministry RETIE, both OIT/Cinterfor entries, and Indeed.
7. **Colombia/RETIE qualifier:** The Portuguese edition preserves the English source's cautious handling of the Ministry page's inconsistent year information for Resolution 40284 and does not invent or resolve the disputed year.
...
10. **Language quality:** Portuguese is Brazilian Portuguese with natural reader-facing phrasing. English proper names, occupational codes, official program names, and source labels are retained where translation could reduce traceability. Colombian legal terms and Spanish SENA program names are preserved as source identifiers.
...
**Portuguese Localization: PASS.** The controlled `pt-BR` master may be used as an input to trilingual Technical QA.
